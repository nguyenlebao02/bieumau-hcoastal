      ...
      <div className="max-w-2xl mx-auto space-y-4">
        <div className="bg-white rounded-xl shadow p-4 flex items-center justify-between sticky top-4 z-10">
          ...
          <div className="flex gap-2">
            <button onClick={() => setForm(emptyForm)} className="px-4 py-2 text-sm rounded-lg border border-gray-300 hover:bg-gray-50 transition">Xóa form</button>
            <button onClick={exportPDF} disabled={exporting} className="px-4 py-2 text-sm rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition disabled:opacity-50">{exporting ? "Đang xuất..." : "Xuất PDF"}</button>
          </div>
        </div>

        <div ref={formRef} className="bg-white rounded-xl shadow-lg p-8" style={{ fontFamily: "Times New Roman, serif" }}>
